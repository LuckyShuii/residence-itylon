...
(14, 'amandier', 'L\’Amandier est une maison confortable composée de 3 chambres.', 'amandier_preview.jpg', '', 6, 6, 1, 1, 1, 1, 1, 3, 0, 2, 3, 0, 'L’Amandier est une maison confortable composée de 3 chambres avec lit en 140, 2 salle d’eau et un toilette séparé. Elle peut accueillir 6 personnes. La cuisine est bien équipée. Une salle à manger vous permettra de prendre vos repas à l’intérieur avec la vue sur la montagne. La terrasse très spacieuse est équipée de transats ainsi que d’un barbecue. La place de parking est située juste à côté de la maison.'),
