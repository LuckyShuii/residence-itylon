...
const scrollToDetail = () => {
  const activityContainer = document.querySelector('#allActivities');
...
<template>
  <div class="w-[306px] bg-green-light rounded-[10px] flex flex-col">
    ...
    <div class="flex items-center justify-between px-[16px] py-[14px] flex-1">
      ...
      <RouterLink :to="'/activites/' + Slugify(activity.title).toLowerCase() + '?a=' + activity.id + '#detail'" @click="scrollToDetail"
      >
