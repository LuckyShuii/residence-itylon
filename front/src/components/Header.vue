...
<template>
    <header class="max-w-[1272px] bg-black bg-opacity-40 text-white flex justify-between items-center my-[32px] py-[18px] px-[31px] rounded-xl absolute w-full left-1/2 transform -translate-x-1/2 z-20">
        <RouterLink to="/">
