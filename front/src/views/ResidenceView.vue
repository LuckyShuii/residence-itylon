...
<template>
  ...
  <div class="flex justify-center mt-[80px] max-w-[1270px] mx-auto">
    <div class="flex justify-center max-h-[420px]">
      <div class="py-[40px] px-[35px] w-[570px] bg-green-light rounded-xl">
        <h2 class="mb-4 font-mistress text-[40px]">{{residenceHeaderTitle}}</h2>
        <p v-html="description"></p>
      </div>
      <div class="h-full bg-green-light w-[670px] rounded-xl ml-[30px]">
        <img src="/src/assets/photos/home/image4.jpg" alt="residence entrance" class="object-cover w-full h-full rounded-xl"/>
      </div>
    </div>
  </div>
  ...
  <div class="mt-[80px] max-w-[1270px] mx-auto">
    <div class="flex space-x-[40px] mb-[40px]">
      <div class="w-[324px] h-[281px]">
        <img src="/src/assets/photos/residence/residence_entrance_dirt.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[310px] h-[281px]">
        <img src="/src/assets/photos/residence/residence_bridge.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[556px] h-[281px]">
        <img src="/src/assets/photos/residence/residence_tree_lavander.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
    </div>

    <div class="flex space-x-[40px] mb-[40px]">
      <div class="w-[556px] h-[392px]">
        <img src="/src/assets/photos/home/image3.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[310px] h-[392px]">
        <img src="/src/assets/photos/residence/residence_pool.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[324px] h-[392px]">
        <img src="/src/assets/photos/residence/residence_main.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
    </div>

    <div class="flex space-x-[40px]">
      <div class="w-[324px] h-[392px]">
        <img src="/src/assets/photos/residence/residence_h_trees.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[310px] h-[392px]">
        <img src="/src/assets/photos/residence/residence_laverie_door.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
      <div class="w-[556px] h-[392px]">
        <img src="/src/assets/photos/home/image2.jpg" alt="" class="object-cover w-full h-full rounded-xl">
      </div>
    </div>
  </div>
</template>
